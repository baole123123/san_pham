        ...
        <div class="card-body">
            <div class="table-responsive text-nowrap ">
                <table class="table table-bordered border-top">
                    <form action="{{ route('tags.index') }}" method="get" enctype="multipart/form-data">
                        @csrf
                        <thead>
                            <tr>
                                <th>TT</th>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('tags.edit',$tag->id)}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
